...
export function StatsCard({ title, value, icon, color }: StatsCardProps) {
  const colorClasses = {
    green: "bg-F5E8D3 text-yellow-400 border-2 border-yellow-400",
    yellow: "bg-F5E8D3 text-yellow-400 border-2 border-yellow-400",
    red: "bg-F5E8D3 text-red-400 border-2 border-red-400",
  }
