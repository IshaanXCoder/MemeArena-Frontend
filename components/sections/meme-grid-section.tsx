  ...
  if (isLoadingMemes) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-lg font-bold text-gray-600">Loading battles...</p>
      </div>
    )
  }
  ...
  if (memes.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="text-2xl font-black text-gray-800 mb-2">No Battles Yet</h3>
        <p className="text-gray-600 mb-6">Be the first to upload a meme and enter the arena!</p>
