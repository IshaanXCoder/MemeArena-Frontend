...
export function LeaderboardSection() {
  ...
  if (memes.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-lg font-bold text-gray-400 mb-2">📭 No Battles Yet</p>
        <p className="text-sm text-gray-500">Be the first to enter the arena!</p>
      </div>
    )
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-black text-white p-4">
        ...
        <p className="text-gray-400 uppercase text-sm">
          Twitter engagement oracle and reputation leaderboard
        </p>
      </div>
