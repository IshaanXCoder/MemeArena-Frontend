  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mb-8 text-center">
        <h2 className="text-5xl font-black text-black mb-4 uppercase tracking-tight">🔥 TRENDING BATTLES</h2>
        <p className="text-xl font-bold text-gray-700 uppercase tracking-wide">MEMES GOING HEAD-TO-HEAD</p>
      </div>
