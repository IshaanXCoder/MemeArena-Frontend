...
export function LiveStatsSection() {
  ...
  if (isLoading) {
    return (
      <section className="px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#F5E8D3', minHeight: '100px', paddingTop: '2rem'}}>
        <div className="container mx-auto">
          <div className="text-center py-8">
            <Loader2 className="h-8 w-8 animate-spin mx-auto mb-1" style={{ color: '#4C8C88' }} />
            <p className="text-sm font-bold" style={{ color: '#3B3B3B' }}>Loading platform stats...</p>
          </div>
        </div>
      </section>
    )
  ...
  return (
    <section className="px-4 sm:px-6 lg:px-8" style={{ backgroundColor: '#F5E8D3', minHeight: '100px', paddingTop: '2rem', paddingBottom: '2rem' }}>
      <div className="container mx-auto">
        {error && (
        ...
        {!isConnected && (
          <div className="text-center mt-4">
            <p className="text-xs" style={{ color: '#3B3B3B' }}>Connect wallet to view live blockchain data</p>
          </div>
        )}
      </div>
    </section>
